...
import { ChevronDownIcon, GithubIcon, LinkedinIcon } from 'lucide-react';
          ...
          <div className='w-full max-w-[648px] flex flex-col gap-8'>
            ...
            <div className='bg-[#f5f6f8] rounded-2xl p-4'>
              <p className='font-medium text-[#383838] text-base text-center '>
                Your first selection populates your Username, Profile picture
                and Bio
              </p>
            </div>
            ...
            <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4'>
              {socialPlatforms.map((platform, index) => (
                ...
                >
                  ...
                  <Button className='w-full bg-gradient-to-r from-[#f83e67] to-[#a50976] hover:bg-[#d42e63] text-white rounded-xl'>
                    Connect
                  </Button>
                </div>
              ))}
            ...
            <div className='mt-8 flex justify-center'>
              <Button
                type='submit'
                className='w-[463px] h-[60px] rounded-[13.31px] bg-gradient-to-r from-[#f83e67] to-[#a50976] text-white font-medium text-[15px]'
              >
                Done
              </Button>
            </div>
